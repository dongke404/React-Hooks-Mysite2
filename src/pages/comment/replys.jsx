            ...
            <div className="cell">
              <table>
                <tbody className="cmtTable" >
                  <tr>
                    <td className="td1">
                      <img className="avatar30" src={item.authorHead} alt="" loading="lazy" />
                    </td>
                    <td className="td2">
                    </td>
                    <td className="td3">
                      <div className="fr">
                        <span className="iconfont icon-icon_reply gray toreply" onClick={showReply} flag={"replys" + item.id} ></span>
                        <span className="no">{index + 1}</span>
                      </div>
                      <div className="sep3"></div>
                      <strong>{item.author}&nbsp;回复&nbsp;{item.to_nickname} </strong>
                      <span className="ago"> {moment(item.datetime).fromNow()}</span>
                              &nbsp;&nbsp;
              ...
              <div className="replyBox" style={{ display: "none", width: 500, marginLeft: 50 }} id={"replys" + item.id} >
                <div className="sep5"></div>
                <table>
                  <tbody>
                    <tr>
                      <td>
                        <input placeholder={"回复" + item.author} style={{ height: 30, width: 400 }} value={replyTXT} onChange={onchangeTxt} />
                      </td>
                      <td>
                        <button
                          style={{ height: 30 }}
