  ...
  return (
    <div>
      ...
      <div className='header-right'>
        {user ?
          <div>
            <Avatar size="large" src={avatarSrc} onClick={() => setishow(ishow => !ishow)} ></Avatar>
            <Popover title="" trigger="click" content={<Content logout={logout} setModalShow={setModalShow} ></Content>}>
              <div className="pulldownicon">
                {user.nickname}<CaretDownOutlined />
              </div>
            </Popover>
          </div>
          :
      ...
      <Cavatar ishow={ishow} setModalHidden={setModalHidden} setAvatar={setAvatar}/>
    </div>
  )
}
